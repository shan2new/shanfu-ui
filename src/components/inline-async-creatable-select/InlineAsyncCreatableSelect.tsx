...
} from '../async-select/AsyncCreatableSelect'
import { cn } from '../../lib/utils'

export interface InlineAsyncCreatableSelectProps<T>
  extends Omit<AsyncCreatableSelectProps<T>, 'value' | 'onChange'> {
  /** Current value */
  value: string
...
export function InlineAsyncCreatableSelect<T>({
  ...
  const enhancedCreateOption = useCallback(
